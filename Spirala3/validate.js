...
function ValidateAutizam(){
    if(!ValidateImeAutizam())
        return false;
    if(!ValidatePrezimeAutizam())
        return false;
}
...
var regexDatum = /^([1][9][0-9][0-9])\-([0][13578]|[1][02])\-([0][1-9]|[12][0-9]|[3][01]$)|([1][9][0-9][0-9])\-([0][469]|[1][1])\-([0][1-9]|[12][0-9]|[3][0]$)|([1][9][0-9][0-9])\-[0][2]\-([0][1-9]|[12][0-9]$)$/
